...
namespace FullFledgedAPI.Helper
{
    public class BasicAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        public BasicAuthenticationHandler(IOptionsMonitor<AuthenticationSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock, FullFledgedAPIContext context) : base(options, logger, encoder, clock)
        {
            _context = context;
        }
        ...
        protected async override Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            if (headerValue != null)
            {
                ...
                {
                    return AuthenticateResult.Fail("UnAuhorized");
                }
            }
            else
            {
